...
public class TwitterBusinessIdAPIService implements Callback<TwitterBusiness> {
	...
	public void start() {
        ...
        Call<TwitterBusiness> call = businessDiscoveryAPI.getBusinessId(BASE_URL + "users/by/username/" + companyName + "?tweet.fields=");
        call.enqueue(this);
	...
	@Override
	public void onFailure(Call<TwitterBusiness> call, Throwable t) {
		t.printStackTrace();
	}

	@Override
	public void onResponse(Call<TwitterBusiness> call, Response<TwitterBusiness> response) {
